...
echo "===== START N1_from_E02_head_only_posw_v3_block224_calibrated_lower_head_lr ====="
...
echo "===== END N1_from_E02_head_only_posw_v3_block224_calibrated_lower_head_lr ====="

echo "===== START N2_from_E02_head_only_posw_v3_block224_calibrated_lower_encoder_lr ====="
PYTHONPATH=src:. conda run -n HyperSIGMA python research/training/train_wetness_pretrain.py \
  --input_dir datasets/processed/wetness_pretrain_v3 \
  --manifest_path annotations/manifests/wetness_manifest_from_confidence_ali_blocksplit.csv \
  --epochs 20 \
...
echo "===== END N2_from_E02_head_only_posw_v3_block224_calibrated_lower_encoder_lr ====="

echo "===== START N3_from_E02_head_only_posw_v3_block224_calibrated_longer_epochs ====="
PYTHONPATH=src:. conda run -n HyperSIGMA python research/training/train_wetness_pretrain.py \
  --input_dir datasets/processed/wetness_pretrain_v3 \
  --manifest_path annotations/manifests/wetness_manifest_from_confidence_ali_blocksplit.csv \
  --epochs 30 \
...
echo "===== END N3_from_E02_head_only_posw_v3_block224_calibrated_longer_epochs ====="

echo "===== START N4_from_E02_head_only_posw_v3_block224_calibrated_progressive ====="
PYTHONPATH=src:. conda run -n HyperSIGMA python research/training/train_wetness_pretrain.py \
  --input_dir datasets/processed/wetness_pretrain_v3 \
  --manifest_path annotations/manifests/wetness_manifest_from_confidence_ali_blocksplit.csv \
  --epochs 30 \
...
echo "===== END N4_from_E02_head_only_posw_v3_block224_calibrated_progressive ====="
