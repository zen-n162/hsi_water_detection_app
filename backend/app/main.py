...
def health():
    ...
    deploy_config_exists = settings.default_deploy_config.exists()
    inference_readiness: dict[str, object] = {
        "ready_for_inference": False,
        "missing_assets": [],
        "error": None,
    }

    if deploy_config_exists:
        try:
            bundle = load_deploy_config_bundle()
            inference_readiness = build_deploy_asset_status(
                bundle["resolved"],
    ...
    return {
        ...
        "default_deploy_config_exists": deploy_config_exists,
